...
{playerId:"aaron-judge",name:"Aaron Judge",meta:"NYY • OF • Power Leader"},
{playerId:10003,name:"Bobby Witt Jr.",meta:"KC • SS • Top Dynasty"},
{playerId:10004,name:"Julio Rodriguez",meta:"SEA • OF • Buy Low"},
{playerId:10005,name:"Ronald Acuna Jr.",meta:"ATL • OF • Injury Recovery"},
{playerId:10006,name:"Jackson Holliday",meta:"BAL • INF • Top Prospect"},
...
searchResults.innerHTML = "";matches.forEach(player => {
...
searchResults.appendChild(result);result.addEventListener("click",() => {
...
playerSearch.addEventListener("click",(event) => {event.stopPropagation();});
// SEARCH ICON BUTTON =====================================================
const mobileSearchBtn =
document.getElementById("mobile-search-btn");
if(mobileSearchBtn){mobileSearchBtn.addEventListener("click",(event) => {
    event.stopPropagation();searchOverlay.classList.remove("hidden");
	expandedSearch.value = "";setTimeout(() => {
...
document.getElementById("expanded-search");
const expandedSearchResults =
document.getElementById("expanded-search-results");
// OPEN SEARCH OVERLAY ====================================================
    ...
    player => {
        ...
        result.addEventListener(
            "click",() => {
                ...
                `player-public.html?id=${player.playerId}`;});});}
// LIVE SEARCH ============================================================
...
function updateSearchPlaceholder(){
    ...
    if(window.innerWidth < 910){search.placeholder = "Search";
    }else{search.placeholder ="Search any active player";}}
...
window.addEventListener("scroll",() =>
    {if(window.scrollY > 40){publicHeader.style.height ="60px";}
    else{publicHeader.style.height ="68px";}});
const publicHomepageBtn =
document.getElementById("homepage-btn");
...
document.getElementById("homepage-btn")?
    .addEventListener("click",() =>
        {window.location.href ="index.html";});
document.getElementById("nav-rankings")?
    .addEventListener("click",() =>
        {window.location.href ="rankings.html";});
document.getElementById("nav-trending")?
    .addEventListener("click",() =>
        {window.location.href ="trending.html";});
document.getElementById("nav-trade")?
    .addEventListener("click",() =>
...
moreBtn.addEventListener("click",(event) => {event.stopPropagation();
moreDropdown.classList.toggle("more-open");});
document.addEventListener("click",() =>
    {moreDropdown.classList.remove("more-open");});
document.getElementById("nav-injuries")?
    .addEventListener("click",() =>
	{window.location.href ="injuries.html";});
document.getElementById("nav-waiver")?
    .addEventListener("click",() =>
	{window.location.href ="waiver.html";});
document.getElementById("nav-buylow")?
    .addEventListener("click",() =>
	{window.location.href ="buylow.html";});
document.getElementById("nav-boombust")?
    .addEventListener("click",() =>
	{window.location.href ="boombust.html";});
document.getElementById("nav-teamstats")?
    .addEventListener("click",() =>
	{window.location.href ="teamstats.html";});
// MORE MENU DUPLICATE BUTTONS ============================================
document.getElementById("more-rankings")?
    .addEventListener("click",() =>
	{window.location.href ="rankings.html";});
document.getElementById("more-trending")?
    .addEventListener("click",() =>
	{window.location.href ="trending.html";});
document.getElementById("more-trade")?
    .addEventListener("click",() =>
	{window.location.href ="trade.html";});
// LOGIN BUTTON ===========================================================
document.getElementById("public-login-btn")?
    .addEventListener("click",() =>
	{window.location.href ="login.html";});
// SIGNUP BUTTON ==========================================================
document.getElementById("public-signup-btn")?
    .addEventListener("click",() =>
